...
with mp_pose.Pose(
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            y_linha3_11_23 = y11 + 0.21 * comprimento_linha_11_23
            y_linha3_12_24 = y12 + 0.21 * comprimento_linha_12_24
            
            y_linha4_11_23 = y11 + 0.28 * comprimento_linha_11_23
            y_linha4_12_24 = y12 + 0.28 * comprimento_linha_12_24
            
            y_linha5_11_23 = y11 + 0.38 * comprimento_linha_11_23
            y_linha5_12_24 = y12 + 0.38 * comprimento_linha_12_24
            ...
            x_linha5_11_23 = calcular_coordenadas_x(y_linha5_11_23, m_11_23, b_11_23)
            x_linha5_12_24 = calcular_coordenadas_x(y_linha5_12_24, m_12_24, b_12_24)
            ...
            # cv2.line(image, (int(x11), int(y11)), (int(x12), int(y12)), color=(0, 0, 255), thickness=2)
            ...
            # cv2.line(image, (int(x_linha5_11_23), int(y_linha5_11_23)),
            #           (int(x_linha5_12_24), int(y_linha5_12_24)), color=(0, 0, 255), thickness=2)
            ...
            desenhar_pontos(image, x11, y11, x12, y12, 0.38)
            desenhar_pontos(image, x_linha2_11_23, y_linha2_11_23, x_linha2_12_24, y_linha2_12_24,0.39)
            desenhar_pontos(image, x_linha3_11_23, y_linha3_11_23, x_linha3_12_24, y_linha3_12_24,0.34)
            desenhar_pontos(image, x_linha4_11_23, y_linha4_11_23, x_linha4_12_24, y_linha4_12_24,0.11)
            desenhar_pontos(image, x_linha5_11_23, y_linha5_11_23, x_linha5_12_24, y_linha5_12_24,0.11)
        ...
        # Save the screenshot to a specific folder
        screenshot.save(r'C:\Projetos\Python_ISEP\IHM_Projeto_01\Final\screen_shots\screenshot_{}.png'.format(timestamp))
