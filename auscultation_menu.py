...
file1_button = ttk.Button(main_menu_frame, text="Cardiac Auscultation", command=lambda: button_clicked(r'C:\path\to\your\cardiac_pulmonar_ausc.py', loading_label), style="TButton")
file2_button = ttk.Button(main_menu_frame, text="Anterior Auscultation", command=lambda: button_clicked(r'C:\path\to\your\anterior_pulmonar_ausc.py', loading_label), style="TButton")
file3_button = ttk.Button(main_menu_frame, text="Posterior Auscultation", command=lambda: button_clicked(r'C:\path\to\your\posterior_pulmonar_ausc.py', loading_label), style="TButton")
