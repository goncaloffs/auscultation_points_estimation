...
with mp_pose.Pose(
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            Omidy = (results.pose_landmarks.landmark[11].y + results.pose_landmarks.landmark[12].y) / 2
            Amidy = (results.pose_landmarks.landmark[23].y + results.pose_landmarks.landmark[24].y) / 2
            
            dx = abs(np.subtract(results.pose_landmarks.landmark[11].x, results.pose_landmarks.landmark[12].x))
            dy = abs(Omidy - Amidy)
            
            # #Em y
            # propy_l1_cor = (dy*0.13)/0.70
            # propy_l2_cor = (dy*0.31)/0.70
            # propy_l3_cor = (dy*0.34)/0.70
            ...
            #Em x
            # propx_l1_cor = (dx*0.41*0.91)/0.37
            # propx_l2_cor = (dx*0.35*0.81)/0.32
            # propx_l3_cor = (dx*0.20*0.80)/0.32
            ...
            y_linha1_11_23 = y11 + propy_l1_cor * comprimento_linha_11_23
            y_linha1_12_24 = y12 + propy_l1_cor * comprimento_linha_12_24
            
            y_linha2_11_23 = y11 + propy_l2_cor * comprimento_linha_11_23
            y_linha2_12_24 = y12 + propy_l2_cor * comprimento_linha_12_24
            
            y_linha3_11_23 = y11 + propy_l3_cor * comprimento_linha_11_23
            y_linha3_12_24 = y12 + propy_l3_cor * comprimento_linha_12_24
            ...
            def desenhar_pontos(image, x1, y1, x2, y2, proporcao, npontos):
            ...
            #ATENÇAO: AQUI USEI UMA FUNÇÃO desenhar_pontos LIGEIRAMENTE DIFERENTE (COM O PARAMETRO NPONTOS)
            # PORQUE AS LINHAS 2 E 3 APENAS TÊM 1 PONTO
            desenhar_pontos(image, x_linha1_11_23, y_linha1_11_23, x_linha1_12_24, y_linha1_12_24, propx_l1_cor, 2)
            desenhar_pontos(image, x_linha2_11_23, y_linha2_11_23, x_linha2_12_24, y_linha2_12_24, propx_l2_cor, 1)
            desenhar_pontos(image, x_linha3_11_23, y_linha3_11_23, x_linha3_12_24, y_linha3_12_24, propx_l3_cor, 1)
